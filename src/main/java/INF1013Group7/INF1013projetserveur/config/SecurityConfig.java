...
import INF1013Group7.INF1013projetserveur.jwtFilter.JwtTokenFilter;
import INF1013Group7.INF1013projetserveur.jwtFilter.JwtUsernamePasswordAuthenticationFilter;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
               ...
               */
                ...
                .authorizeRequests()
                .antMatchers("/login", "/api/intervenant/signup","/api/directeur/signup")
                .permitAll()
